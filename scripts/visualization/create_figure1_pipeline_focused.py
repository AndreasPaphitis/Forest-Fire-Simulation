...
ax = panels[0]
ax.set_title('A) Raw LiDAR Point Cloud Density', fontsize=14, fontweight='bold', pad=15, color=colors['dark_gray'])
...
ax = panels[1]
ax.set_title('B) Height Normalization', fontsize=14, fontweight='bold', pad=15, color=colors['dark_gray'])
...
ax = panels[2]
ax.set_title('C) NRD Calculation', fontsize=14, fontweight='bold', pad=15, color=colors['dark_gray'])
...
ax = panels[3]
ax.set_title('D) PAD Derivation', fontsize=14, fontweight='bold', pad=15, color=colors['dark_gray'])
...
ax = panels[4]
ax.set_title('E) Computational Efficiency', fontsize=14, fontweight='bold', pad=15, color=colors['dark_gray'])
...
ax = panels[5]
ax.set_title('F) Data Volume Reduction', fontsize=14, fontweight='bold', pad=15, color=colors['dark_gray'])
